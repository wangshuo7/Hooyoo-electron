<template>
  <div class="container">
      ...
      >
        ...
        >
          <a :href="item.href" class="swiperbox-a">
            <img class="swiper-img" :src="item.swiper_src" :alt="item.alt" />
          </a>
    ...
    <ul class="sidebox">
      ...
      >
        <a href="#">
          <div v-show="index === activeSlide" class="side-mark"></div>
...
const Images = ref<any>([
  {
    swiper_src: './swiper1.jpg',
    href: '#',
    side_src: './swiper-side1.webp',
    alt: 'Swiper 1',
  ...
  {
    swiper_src: './swiper2.jpg',
    side_src: './swiper-side2.webp',
    alt: 'Swiper 2',
    name: '《Alan Wake 2》',
    time: '已推出',
    discription:
  ...
  {
    swiper_src: './swiper3.jpg',
    side_src: './swiper-side3.webp',
    alt: 'Swiper 3',
    name: '《崩坏：星穹铁道》',
    time: '版本 1.5',
  ...
  {
    swiper_src: './swiper4.jpg',
    side_src: './swiper-side4.webp',
    alt: 'Swiper 4',
  ...
  // {
  //   swiper_src: './swiper5.jpg',
  //   side_src: './swiper-side5.webp',
  //   alt: 'Swiper 5',
  ...
  // }
  // {
  //   swiper_src: './swiper6.webp',
  //   side_src: './swiper-side6.webp',
  //   alt: 'Swiper 6',
...
@media screen and (min-width: 1601px) and (max-width: 2060px) {
  .container {
    width: 100%;
    // min-height: 306.56px;
    // min-width: 720px;
